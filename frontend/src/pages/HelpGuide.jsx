  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What does "Accept Route" do?', a: 'Creates vendor assessments for each store in your route so you\'re ready to start filling them out. You can then tap "Assess Vendors" on any store to open its assessment.' },
        { q: 'How do I start an assessment from the Route tab?', a: 'Tap "Assess Vendors" on any store in your route.' },
        { q: 'What happens when I Skip or Remove a store?', a: 'Removes the vendor assessments for that store. Use "Restore" to add them back.' },
        { q: 'How does Re-optimize Route work?', a: 'Recalculates the best route using current time and traffic, keeping stores you\'ve already completed at the top.' },
        { q: 'A store on my route shows "Completed" — what does that mean?', a: 'It means all vendor assessments at that store have been submitted. Your data is saved. The store moves to the Completed section at the top of your route.' },
